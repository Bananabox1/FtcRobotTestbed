...
@TeleOp(name="Wesley's HellowWorld", group="Linear OpMode")
public class HellowWorld_WG extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sensorTouch = hardwareMap.get(TouchSensor.class, "touch_sensor");
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            telemetry.addData("Message", "Hello Robot from Wesley");

            double dist = sensorDistance.getDistance(DistanceUnit.MM);
            telemetry.addData("Distance Sensor", "Distance: %6.2f", dist);
